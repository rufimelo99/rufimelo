...
function add_css$1() {
	...
	style.id = "svelte-93oqew-style";
	style.textContent = ".parallax-container.svelte-93oqew{width:100%;position:relative;overflow:hidden;-ms-transform:translate3d(0, 0, 0);-webkit-transform:translate3d(0, 0, 0);transform:translate3d(0, 0, 0);box-sizing:border-box}";
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "parallax-container svelte-93oqew");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(window_1, "resize", /*resize_handler*/ ctx[20]),
					...
					listen(window_1, "resize", /*onwindowresize*/ ctx[22])
				];
...
function instance$1($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, scrollTop, value => $$invalidate(17, $scrollTop = value));

	// eventually filled with ParallaxLayer objects
	const layers = writableSet(new Set());

	component_subscribe($$self, layers, value => $$invalidate(16, $layers = value));
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$layers, innerHeight*/ 65538) {
...
class Parallax extends SvelteComponent {
	constructor(options) {
		super();
		if (!document_1.getElementById("svelte-93oqew-style")) add_css$1();
...
function create_fragment(ctx) {
	...
	return {
		c() {
			div = element("div");
			if (default_slot) default_slot.c();
			attr(div, "class", "parallax-layer svelte-qcp0z5");
...
class ParallaxLayer extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance, create_fragment, safe_not_equal, { rate: 4, offset: 5, span: 6, style: 0 });
	}
}
